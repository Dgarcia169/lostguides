                        ...
                        <div class="blog-post-content">
                            ...
                            <div class="blog-post-meta">
                                ...
                                <ul>
                                    ...
                                    <li><i class="far fa-comments"></i><?php comments_number("No comments", "1 comment", "% comments"); ?></li>
                            ...
                            <div class="avatar-post mt-50 mb-70">
                                <div class="post-avatar-img">
                                    <img src="<?php // echo bloginfo('template_directory');?>/img/blog/post_avatar_img.png" alt="img">
                                </div>
                                <div class="post-avatar-content">
                                    <h5>bryan adams</h5>
                                    <p>Download App Play Online. No Download Required. Highlights text of the printing and typeseng industry ducational math .</p>
                                </div>
                            </div>
                            -->
                            ...
                            <div class="blog-comment mb-70 mt-50">
                                <div class="sidebar-title mb-45">
                                    <h4><?php comments_number('COMMENTS (0)', 'COMMENTS (1)', 'COMMENTS (%)'); ?></h4>
                                </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="comment-avatar-thumb">
                                            <img src="<?php // echo bloginfo('template_directory');?>/img/blog/comment_thumb01.png" alt="">
                                        </div>
                                        <div class="comment-text">
                                            <div class="comment-avatar-info">
                                                <h4><a href="#">erecka malson</a><span class="comment-time">10 Mar 2020</span></h4>
                                    ...
                                    <li class="comment-children">
                                        <div class="comment-avatar-thumb">
                                            <img src="<?php // echo bloginfo('template_directory');?>/img/blog/comment_thumb02.png" alt="">
                                        </div>
                                        <div class="comment-text">
                                            <div class="comment-avatar-info">
                                                <h4><a href="#">janet jackson</a><span class="comment-time">10 Mar 2020</span></h4>
                                                <div class="comment-reply">
                                                    <a href="#"><i class="fas fa-reply"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="comment-avatar-thumb">
                                            <img src="<?php // echo bloginfo('template_directory');?>/img/blog/comment_thumb03.png" alt="">
                                        </div>
                                        <div class="comment-text">
                                            <div class="comment-avatar-info">
                                                <h4><a href="#">bryan adams</a><span class="comment-time">10 Mar 2020</span></h4>
                                                <div class="comment-reply">
                                                    <a href="#"><i class="fas fa-reply"></i></a>
                                                </div>
                                            </div>
